defmodule ExSync.BeamMonitor do
 ...
 def handle_info({:file_event, _watcher_pid, {path, events}}, state) do
   ...
   {:noreply, %State{state | finished_reloading_timer: timer_ref}}
 end
 ...
 def handle_info(:throttle_timer_complete, state) do
   ...
   # Hacky!
   # Better would be to make this the main point for the canceling and
   # scheduling of the timer and maybe deprecate the reload_time configuration
   # TODO: I don't understand why you would want this here at all???
   # send(self(), :reload_complete)
